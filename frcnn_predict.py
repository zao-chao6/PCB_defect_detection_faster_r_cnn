...
class FRCNN(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"    : r'faster-rcnn-pytorch-master\logs\best_epoch_weights.pth',
        "classes_path"  : 'PCB_DataSet/cls_classes.txt',
        #---------------------------------------------------------------------#
        #   网络的主干特征提取网络，resnet50，resnet101或者vgg
        #---------------------------------------------------------------------#
        # "backbone"      : "resnet50",
        "backbone"      : "resnet101",
        #---------------------------------------------------------------------#
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='model_data/simhei.ttf', size=np.floor(8e-3 * image.size[1] + 0.5).astype('int32'))
        thickness   = int(max(((image.size[0] + image.size[1]) // np.mean(input_shape))-5, 1))
        #---------------------------------------------------------#
        #   计数
        #---------------------------------------------------------#
        if count:
