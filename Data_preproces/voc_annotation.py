...
#-------------------------------------------------------------------#
classes_path        = r'F:\Desktop\PCB_code\PCB_DataSet\cls_classes.txt'
#--------------------------------------------------------------------------------------------------------------------------------#
...
#   默认指向根目录下的VOC数据集
#-------------------------------------------------------#
PCB_DataSet_path=r'PCB_DataSet'
    ...
    if annotation_mode == 0 or annotation_mode == 2:
        ...
        for image_set in PCB_Data_Sets:
            ...
            for image_id in image_ids:
                list_file.write('%s/JPEGImages/%s.jpg'%(os.path.abspath(PCB_DataSet_path),image_id))#在训练集和测试集中写入图片路径信息
